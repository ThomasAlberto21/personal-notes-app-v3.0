...
export default function CardNotes(props) {
  return (
    <div className='w-full mx-auto h-auto px-6 py-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-900 lg:mb-0 my-5 flex flex-col justify-end'>
      <div className='mb-5'>
